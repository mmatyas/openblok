...
Statistics::Statistics(MultiplayerState& parent, AppContext& app)
    : fadein_percent(
...
void Statistics::update(MultiplayerState& parent, const std::vector<Event>& events, AppContext& app)
{
...
void Statistics::drawPassive(MultiplayerState& parent, GraphicsContext& gcx) const
{
